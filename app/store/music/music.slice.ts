...
export const musicSlice = createSlice({
  ...
  reducers: {
    setActiveIndex: (state, action) => {
      ...
      localStorage.setItem('activeTrackIndex', JSON.stringify(state.activeIndex))
    },
    ...
    setActivePlaylist: (state, action) => {
      ...
      localStorage.setItem('activePlaylist', JSON.stringify(state.activePlaylist))
    },
...
export const { setActiveIndex, setActiveId, setActivePlaylist, setIsPlaying } = musicSlice.actions
