import { getAlbumsUrl, getAuthorsUrl, getPopularAlbumsUrl } from 'config/url.config'
...
const Home: FC<IHome> = ({ trendingTracks, newTracks, albums, popularAlbums, authors, slides }) => {
  console.log(albums)
  return (
    <Meta>
      <Layout>
        ...
        <Gallery title="News albums" data={albums} type="albums" link={getAlbumsUrl()} />
      </Layout>
    </Meta>
  )
}
