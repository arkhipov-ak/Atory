...
const Header: FC<IHeader> = ({
  ...
  return (
    <>
      ...
      <div className={cn(styles.modal, { '!block': isOpen })} onClick={handleIsOpen}>
          ...
          <form onSubmit={handleSubmit(data?.onSubmit)}>
            <Controller
              ...
              render={({ field: { value, onChange } }) => (
                <UploadField onChange={onChange} value={value ? value : poster} folder="profile" />
              )}
            />
            <div>
              <Field placeholder="Add display name" text="Name" {...register('name')} />
